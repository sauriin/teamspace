...
import { Folder, MoreVertical, Pencil, Trash2, RotateCcw, XCircle, Info } from "lucide-react";
...
export default function FolderView({
    folders = [],
    isTrashView = false,
    onFolderClick, // click handler from page.jsx
}) {
        ...
        <>
            <div className="p-4 space-y-10">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5">
                    {folders.map((folder) => (
                        <Card
                            key={folder._id}
                            className="relative group p-4 cursor-pointer hover:bg-gray-800 transition rounded-lg shadow-lg"
                                    ...
                                    <DropdownMenuContent>
                                        ...
                                        <DropdownMenuItem
                                            onClick={async (e) => {
                                                ...
                                                await fetchFileCount(folder._id);
                                            }}
                                        >
            ...
            <Dialog open={!!showDetails} onOpenChange={() => setShowDetails(null)}>
                <DialogContent className="max-w-md">
                    <DialogHeader>
                        <DialogTitle className="text-lg font-semibold">{showDetails?.name}</DialogTitle>
                    ...
                    {showDetails && (
                        <div className="space-y-2 mt-4 text-sm text-gray-100">
                            ...
                            <p>
                                <strong>Created At:</strong> {new Date(showDetails.createdAt).toLocaleString()}
                            </p>
                            <p>
